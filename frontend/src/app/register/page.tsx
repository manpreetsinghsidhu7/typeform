...
export default function Register() {
  ...
  useEffect(() => {
    // If user explicitly visits register, we log them out.
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("username", username); // API expects username
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 pt-16">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            Already have an account? <span onClick={() => router.push("/login")} className="underline cursor-pointer hover:text-gray-900">Log in</span>
          </div>
        </div>
      </div>
