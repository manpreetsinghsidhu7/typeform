    ...
    <div className="flex min-h-screen bg-white text-neutral-900 font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 pt-16">
        <div className="w-full max-w-[360px]">
          <h1 className="text-[28px] font-normal text-neutral-900 mb-2">Sign up</h1>
          ...
          <div className="mt-12 text-center text-sm text-neutral-500">
            Already have an account? <span onClick={() => router.push("/login")} className="underline cursor-pointer font-medium text-neutral-900">Log in</span>
          </div>
        </div>
      </div>
